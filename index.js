...
async function checkAndSendNewRequests() {
    ...
    try {
        ...
        // කාලය නොබලා 'pending' තත්වයේ ඇති සියලුම දත්ත සොයයි
        ...
        for (const req of newRequests) {
            ...
            console.log(`📤 Sent message for: ${req.movieName}`);
        }
    } catch (e) {
...
async function startBot() {
    try {
        ...
        if (SESSION_ID) {
            // "YASIYA-MD=" කොටස තිබේ නම් එය ඉවත් කර පිරිසිදු කරයි
            ...
            console.log('✅ Session Credentials Decoded');
        }
        ...
        sock.ev.on('connection.update', (update) => {
            ...
            if (connection === 'open') {
                ...
                // තත්පර 30කට වරක් DB පරීක්ෂා කරයි
